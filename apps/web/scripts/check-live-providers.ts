...
async function main(){
 ...
 try{
  ...
  for(const question of ["Read the selected demo task and tell me what is blocking it.","Find public code examples for preserving a selected task during a browser WebRTC reconnect."]){
